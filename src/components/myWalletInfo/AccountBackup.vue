  ...
  >
    ...
    >
      ...
      >
        ...
        <v-col
          cols="12"
          class="pr-8 pl-8 mx-auto d-flex justify-center align-center"
        >
          <template v-if="!showPK">
            <v-form
              v-model="passwordPkValid"
              ref="formPasswordPk"
            >
              <v-text-field
                ref="passwordPk"
          ...
          <template v-if="showPK">
            <v-row>
              <v-col
                cols="10"
                class="mx-auto caption justify-center align-center"
              >
              ...
              >
                <v-btn
                  ...
                  icon
                  large
                  @click="$generalService.doCopy('Private key', showPK)"
                >
